...
public class Config {
	public final static String DATAPATH = "dataFiles/"; // If you don't know what the static keyword does, you better go look it up now.
  // Prime file: One prime per line.
  // Cross file: Two primes per line, separated by a comma.
	public static final String APPLICATIONNAME = "PRIMEGUI";
}